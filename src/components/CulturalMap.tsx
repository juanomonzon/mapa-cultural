...
// Estilos del pin titilante inyectados una sola vez
const PIN_STYLES = `
  @keyframes pulse-ring {
    0%   { transform: rotate(-45deg) scale(1); box-shadow: 0 0 0 0 rgba(239,68,68,0.7); }
    70%  { transform: rotate(-45deg) scale(1.08); box-shadow: 0 0 0 8px rgba(239,68,68,0); }
    100% { transform: rotate(-45deg) scale(1); box-shadow: 0 0 0 0 rgba(239,68,68,0); }
  }
  .custom-pin {
    width: 32px;
    height: 32px;
  ...
  .custom-pin.has-event {
    animation: pulse-ring 1.8s ease-out infinite;
    border: 2px solid rgba(239,68,68,0.8);
  }
  .custom-pin.has-event::after {
    content: '';
    position: absolute;
    top: -3px;
    right: -3px;
...
const CulturalMap = () => {
  ...
  // Inyectar estilos del pin una sola vez
  useEffect(() => {
